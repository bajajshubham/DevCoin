...
public class DemoRun {
	...
	public static void main(String[] args) {
		...
		genesisTransaction1.transactionsOutputs
				.add(new TransactionsOutputs(walletB.publicKey, 101f, genesisTransaction1.transactionID));
		BlkChain.UTXOs.put(genesisTransaction.transactionsOutputs.get(0).id,
				genesisTransaction.transactionsOutputs.get(0));
		BlkChain.UTXOs.put(genesisTransaction1.transactionsOutputs.get(0).id,
				genesisTransaction1.transactionsOutputs.get(0));

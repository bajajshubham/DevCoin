...
public class Transaction {
	...
	public Transaction(PublicKey sender, PublicKey recipent, float value,
			ArrayList<TransactionsInputs> transactionsInputs) {
		this.sender = sender;
	...
	public String toString() {
		return "Transaction [transactionID=" + transactionID + ", sender=" + Utility.getStringFromKey(sender)
				+ ", recipent=" + Utility.getStringFromKey(recipent) + ", value=" + value + ", signature="
				+ Arrays.toString(signature) + ", timestamp=" + timestamp + ", transactionsInputs=" + transactionsInputs
	...
	private String calcHash() {
		...
		sequence += 1;
		// TODO
		return Utility.applySHA256(Utility.getStringFromKey(sender) + Utility.getStringFromKey(recipent)
				+ Float.toString(value) + timestamp + sequence);
	}
	...
	public void generateSignature(PrivateKey key) {
		String inp = Utility.getStringFromKey(sender) + Utility.getStringFromKey(recipent) + Float.toString(value)
				+ timestamp;
